...
// Change node
//-----------------------------------------------------------------------
function changeDataTubeNode(elementId, dataTubeId, name, enabled) {
	document.getElementById("node__elementId").setAttribute('value', elementId);
	document.getElementById("node__data_tube_id").setAttribute('value', dataTubeId);
...
function onNodeAction(action, formActionUrl) {
	...
	if (action == "enable") {
		...
		dialogMessage = "Are you sure you want to enable the data tube nodes?";

	} else if (action == "disable") {
		dialogTitle = "Disable Nodes";
		dialogMessage = "Are you sure you want to disable the data tube nodes?";

	} else {
		dialogTitle = action + " Data Cast Nodes";
		dialogMessage = "Are you sure you want to '" + action + "' the data tube nodes?";
	}
