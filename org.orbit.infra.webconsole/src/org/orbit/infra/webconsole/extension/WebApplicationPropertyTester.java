...
public class WebApplicationPropertyTester implements IPropertyTester {
	...
	public static String ID = "org.orbit.infra.webconsole.WebApplicationPropertyTester";
	...
	public boolean accept(Object context, Object source, Object target, Map<String, Object> args) {
		...
		if (bundleContext != null) {
			...
			PropertyUtil.loadProperty(bundleContext, properties, WebConstants.INFRA__WEB_CONSOLE_AUTOSTART);
			String autoStart = (String) properties.get(WebConstants.INFRA__WEB_CONSOLE_AUTOSTART);
