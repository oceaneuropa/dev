...
public class ConfigElementAttributeAddServlet extends HttpServlet {

	private static final long serialVersionUID = -5477113956993410642L;
				...
				if (!cfg.isOnline()) {
					...
					if (configReg == null) {
						...
						if (configElement == null) {
							...
							succeed = configElement.setAttribute(null, name, value);
						}
					}
				}
			} catch (Exception e) {
