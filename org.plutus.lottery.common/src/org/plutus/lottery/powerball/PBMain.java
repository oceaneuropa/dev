...
public class PBMain {
	...
	public static void main(String[] args) {
		try {
			...
			generate(yearToDraws, idToPredictedNumbers, SystemUtils.getUserDir(), "/doc/svg/powerball_draws__square_01x69__{0}.svg", PBConstants.DRAW_SQUARE_01_PER_ROW);
			generate(yearToDraws, idToPredictedNumbers, SystemUtils.getUserDir(), "/doc/svg/powerball_draws__square_10x07__{0}.svg", PBConstants.DRAW_SQUARE_10_PER_ROW);
			generate(yearToDraws, idToPredictedNumbers, SystemUtils.getUserDir(), "/doc/svg/powerball_draws__square_14x05__{0}.svg", PBConstants.DRAW_SQUARE_14_PER_ROW);
	...
	protected static Display generate_01x69(List<Draw> draws, Map<Integer, List<Draw>> idToPredictedNumbers, boolean showLinks, boolean showPB, boolean showDummyDraw) {
		...
		Display display = new Display(size.getWidth(), size.getHeight());
