	...
	public void start() {
		...
		ManagedServiceFactory managedServiceFactory = new ManagedServiceFactory() {
			...
			public void updated(String pid, Dictionary<String, ?> dictionary) throws ConfigurationException {
				...
				// felix.fileinstall.dir = /Users/yayang/osgi/runspace
				// felix.fileinstall.filename = file:/Users/yayang/osgi/runspace/org.apache.felix.fileinstall-runspace.cfg
				// felix.fileinstall.filter = .*
				// felix.fileinstall.poll = 3000
				// felix.fileinstall.tmpdir = /Users/yayang/osgi/runspace_tmpdir
