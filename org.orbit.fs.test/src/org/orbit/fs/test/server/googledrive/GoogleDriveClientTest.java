...
public class GoogleDriveClientTest {
	...
	public void test030_upload() {
		...
		try {
			...
			boolean test1 = false;
			if (test1) {
				java.io.File localFile = new java.io.File("/Users/example/Downloads/google_drive_test/phone/iPhone.pdf");
			...
			boolean test2 = true;
			if (test2) {
				java.io.File localDir = new java.io.File("/Users/example/Downloads/google_drive_test/phone");
	...
	public void test040_download() {
		...
		try {
			...
			if (test1) {
				...
				java.io.File localDir = new java.io.File("/Users/example/Downloads/google_drive_test/download");
				if (file != null) {
