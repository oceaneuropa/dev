...
public class FsTestWin {
	...
	public void test002_listFiles() throws IOException {
		...
		try {
			// FileRef dir1 = FileRefImpl.newInstance(fs, "/test/dir1");
			// FileRef dir2 = FileRefImpl.newInstance(fs, "/test/dir2");
			// FileRef dir3 = FileRefImpl.newInstance(fs, "/test/dir3");
			// FileRef dir5 = FileRefImpl.newInstance(fs, fs.root(), "test/dir5/07_Document/patent");
			FileRef dir1 = fs.getFile("/test/dir1");
			FileRef dir2 = fs.getFile("/test/dir2");
			FileRef dir3 = fs.getFile("/test/dir3");
			FileRef dir5 = fs.getFile(fs.root(), "test/dir5/07_Document/patent");
			...
			for (FileRef subFile5 : subFiles5) {
				FileSystemWSClientHelper.INSTANCE.walkFolders(fs, subFile5, 0);
			}
			System.out.println();
	...
	public void test003_createFiles() throws IOException {
		...
		// FileRef dir1 = FileRefImpl.newInstance(fs, "/test1");
		// FileRef dir2 = FileRefImpl.newInstance(fs, "/test1/tmp1");
		// FileRef dir3 = FileRefImpl.newInstance(fs, "/test1/tmp2");
		// FileRef file1 = FileRefImpl.newInstance(fs, "/test1/newFile1.txt");
		// FileRef file2 = FileRefImpl.newInstance(fs, "/test1/tmp1/newFile2.txt");
		// FileRef file3 = FileRefImpl.newInstance(fs, "/test1/tmp2/newFile3.txt");
		FileRef dir1 = fs.getFile("/test1");
		FileRef dir2 = fs.getFile("/test1/tmp1");
		FileRef dir3 = fs.getFile("/test1/tmp2");
		FileRef file1 = fs.getFile("/test1/newFile1.txt");
		FileRef file2 = fs.getFile("/test1/tmp1/newFile2.txt");
		FileRef file3 = fs.getFile("/test1/tmp2/newFile3.txt");
	...
	public void test004_uploadFiles() throws IOException {
		...
		// FileRef refDir = FileRefImpl.newInstance(fs, "/");
		FileRef refDir = fs.getFile("/");
	...
	public void test005_uploadUsingOutputStream() throws IOException {
		...
		// FileRef refFile1 = FileRefImpl.newInstance(fs, "/test2/doc.json");
		// FileRef refFile2 = FileRefImpl.newInstance(fs, "/test2/DownloadAllNumbers.txt");
		FileRef refFile1 = fs.getFile("/test2/doc.json");
		FileRef refFile2 = fs.getFile("/test2/DownloadAllNumbers.txt");
	...
	public void test006_downloadFiles() throws IOException {
		...
		// FileRef refFile1 = FileRefImpl.newInstance(fs, "/test2/readme.txt");
		// FileRef refFile2 = FileRefImpl.newInstance(fs, "/test2/Smokingpipes_2016-01-22.pdf");
		FileRef refFile1 = fs.getFile("/test2/readme.txt");
		FileRef refFile2 = fs.getFile("/test2/Smokingpipes_2016-01-22.pdf");
	...
	public void test007_downloadDirectories() throws IOException {
		...
		// FileRef refDir = FileRefImpl.newInstance(fs, "/osgi");
		FileRef refDir = fs.getFile("/osgi");
	...
	public void test008_downloadUsingInputStream() throws IOException {
		...
		// FileRef fileRef1 = FileRefImpl.newInstance(fs, "/test2/readme.txt");
		FileRef fileRef1 = fs.getFile("/test2/readme.txt");
		...
		// FileRef fileRef2 = FileRefImpl.newInstance(fs, "/test2/Smokingpipes_2016-01-22.pdf");
		FileRef fileRef2 = fs.getFile("/test2/Smokingpipes_2016-01-22.pdf");
		...
		// FileRef fileRef3 = FileRefImpl.newInstance(fs, "/test2/doc.json");
		FileRef fileRef3 = fs.getFile("/test2/doc.json");
		...
		// FileRef fileRef4 = FileRefImpl.newInstance(fs, "/test2/DownloadAllNumbers.txt");
		FileRef fileRef4 = fs.getFile("/test2/DownloadAllNumbers.txt");
	...
	public void test009_deleteFiles() throws IOException {
		...
		// FileRef dirRef1 = FileRefImpl.newInstance(fs, "/test2/images");
		// FileRef fileRef2 = FileRefImpl.newInstance(fs, "/test2/readme.txt");
		// FileRef dirRef3 = FileRefImpl.newInstance(fs, "/test2");
		FileRef dirRef1 = fs.getFile("/test2/images");
		FileRef fileRef2 = fs.getFile("/test2/readme.txt");
		FileRef dirRef3 = fs.getFile("/test2");
