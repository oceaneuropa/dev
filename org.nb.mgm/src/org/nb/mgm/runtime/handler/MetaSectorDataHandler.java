package org.nb.mgm.runtime.handler;

import static org.nb.mgm.service.MgmConstants.ERROR_CODE_META_SECTOR_EXIST;
import static org.nb.mgm.service.MgmConstants.ERROR_CODE_META_SECTOR_ILLEGAL_PARAMETER;
import static org.nb.mgm.service.MgmConstants.ERROR_CODE_META_SECTOR_ILLEGAL_STATES;
...
import org.nb.mgm.util.SearchPattern;
import org.nb.mgm.util.Util;

/**
 * Data handler for MetaSector.
 *
 */
public class MetaSectorDataHandler {
	 ...
	 * @param mgmService
	 */
	public MetaSectorDataHandler(MgmService mgmService) {
	...
	public MetaSector getMetaSector(String metaSectorId) throws MgmException {
		...
		if (metaSectorId == null || metaSectorId.isEmpty()) {
			throw new MgmException(ERROR_CODE_META_SECTOR_ILLEGAL_PARAMETER, "Machine Id cannot be empty.", null);
		}
	...
	public void addMetaSector(MetaSector metaSector) throws MgmException {
		...
		if (metaSector == null) {
			throw new MgmException(ERROR_CODE_META_SECTOR_ILLEGAL_PARAMETER, "MetaSector cannot be empty.", null);
		}
	...
	public void deleteMetaSector(String metaSectorId) throws MgmException {
		// Throw exception - empty Id
		if (metaSectorId == null || metaSectorId.isEmpty()) {
			throw new MgmException(ERROR_CODE_META_SECTOR_ILLEGAL_PARAMETER, "MetaSector Id cannot be empty.", null);
		}
		...
		if (!metaSectorToDelete.getMetaSpaces().isEmpty()) {
			throw new MgmException(ERROR_CODE_META_SECTOR_ILLEGAL_STATES, "MetaSector cannot be deleted. Please delete MetaSpaces in the MetaSector first.", null);
		}
		...
		if (foundHomeJoinedThisMetaSector) {
			throw new MgmException(ERROR_CODE_META_SECTOR_ILLEGAL_STATES, "MetaSector cannot be deleted. Please remove Homes which joined this MetaSector first.", null);
		}
