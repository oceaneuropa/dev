...
public final class Util {
	...
	/**
	 * An unmodifiable, empty, sorted set. This value is guaranteed to never change and never be <code>null</code>.
	 */
	public static final SortedSet<?> EMPTY_SORTED_SET = Collections.unmodifiableSortedSet(new TreeSet<Object>());

	/**
	 * A common zero-length string. It avoids needing write <code>NON-NLS</code> next to code fragments. It's also a bit clearer to read.
	 */
	...
	/**
	 * Verifies the given object is an instance of the given class. It is possible to specify whether the object is permitted to be <code>null</code>.
	 * 
	 * @param object
	 *            The object to check; may be <code>null</code>.
	 * @param c
	...
	/**
	 * Compares two boolean values. <code>false</code> is considered to be "less than" <code>true</code>.
	 * 
	 * @param left
	 *            The left value to compare
	 * @param right
	 *            The right value to compare
	 * @return <code>-1</code> if the left is <code>false</code> and the right is <code>true</code>. <code>1</code> if the opposite is true. If they
	 *         are equal, then it returns <code>0</code>.
	 */
	 ...
	 * @return The result of the comparison. <code>null</code> is considered to be the least possible value.
	 */
	 ...
	 * @return The result of the comparison. <code>null</code> is considered to be the least possible value. A shorter array is considered less than a
	 *         longer array.
	 */
	public static final <T extends Comparable<? super T>> int compare(final T[] left, final T[] right) {
		if (left == null && right == null) {
	 ...
	 * 
	 * @param left
	 *            The left list to compare; may be <code>null</code>. This list must only contain instances of <code>Comparable</code>.
	 * @param right
	 *            The right list to compare; may be <code>null</code>. This list must only contain instances of <code>Comparable</code>.
	 * @return The result of the comparison. <code>null</code> is considered to be the least possible value. A shorter list is considered less than a
	 *         longer list.
	 */
	 ...
	 * @return <code>true</code> if the second array is a subsequence of the array list, and they share end elements.
	 */
	...
	/**
	 * Tests whether two arrays of objects are equal to each other. The arrays must not be <code>null</code>, but their elements may be
	 * <code>null</code>.
	 * 
	 * @param leftArray
	 *            The left array to compare; may be <code>null</code>, and may be empty and may contain <code>null</code> elements.
	 * @param rightArray
	 *            The right array to compare; may be <code>null</code>, and may be empty and may contain <code>null</code> elements.
	 * @return <code>true</code> if the arrays are equal length and the elements at the same position are equal; <code>false</code> otherwise.
	 */
	 ...
	 * @return <code>object.hashCode</code> or <code>0</code> if <code>object</code> if <code>null</code>.
	 */
	 ...
	 * @return The hash code for <code>objects</code>; or <code>0</code> if <code>objects</code> is <code>null</code>.
	 */
	 ...
	 * @return <code>true</code> if the first arrays starts with the second list; <code>false</code> otherwise.
	 */
	 ...
	 * @return The value of the translated resource at <code>key</code>. If the key cannot be found, then it is simply the <code>defaultString</code>.
	 */
	public static final String translateString(final ResourceBundle resourceBundle, final String key, final String defaultString) {
	 ...
	 * @return the new string, with all occurrences of <code>find</code> replaced by <code>replacement</code> (not using regular expressions)
	 * @since 3.4
	 */
