...
public class RvdUtils {
	...
	public static File createTempDir() throws RvdException {
		...
		throw new RvdException("Failed to create directory within " + TEMP_DIR_ATTEMPTS + " attempts (tried " + baseName + "0 to " + baseName + (TEMP_DIR_ATTEMPTS - 1) + ')');
	}
	...
	/**
	 * Reduces Map<String,String[]> HttpServletRequest.getParameters() map multivalue parameters to single value ones. It does this by keeping only the first
	 * array item.
	 * 
	 * @param requestMap
