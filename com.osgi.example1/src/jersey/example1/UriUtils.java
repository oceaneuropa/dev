...
// mport org.mobicents.servlet.restcomm.rvd.RvdConfiguration; 
...
public final class UriUtils {
	 ...
	 * 
	 * @param address
	 *            The IP address of the base URI .
	 * @param port
	 *            The port of the base URI.
	 * @param uri
	 *            The relative URI
	 * @return The absolute URI
	 */
	public URI resolve(final URI uri) {
		if (httpConnector == null) {
			if (httpConnectorList == null) {
				...
				} catch (MalformedObjectNameException | AttributeNotFoundException | InstanceNotFoundException | NullPointerException | UnknownHostException | MBeanException | ReflectionException exception) {
