...
import static com.osgi.example1.zipfs.ZipConstants.CENATT;
import static com.osgi.example1.zipfs.ZipConstants.CENATX;
import static com.osgi.example1.zipfs.ZipConstants.CENCOM;
import static com.osgi.example1.zipfs.ZipConstants.CENCRC;
import static com.osgi.example1.zipfs.ZipConstants.CENDSK;
import static com.osgi.example1.zipfs.ZipConstants.CENEXT;
import static com.osgi.example1.zipfs.ZipConstants.CENFLG;
import static com.osgi.example1.zipfs.ZipConstants.CENHDR;
import static com.osgi.example1.zipfs.ZipConstants.CENHOW;
import static com.osgi.example1.zipfs.ZipConstants.CENLEN;
import static com.osgi.example1.zipfs.ZipConstants.CENNAM;
import static com.osgi.example1.zipfs.ZipConstants.CENOFF;
import static com.osgi.example1.zipfs.ZipConstants.CENSIG;
import static com.osgi.example1.zipfs.ZipConstants.CENSIZ;
import static com.osgi.example1.zipfs.ZipConstants.CENTIM;
import static com.osgi.example1.zipfs.ZipConstants.CENVEM;
import static com.osgi.example1.zipfs.ZipConstants.CENVER;
import static com.osgi.example1.zipfs.ZipConstants.CH;
import static com.osgi.example1.zipfs.ZipConstants.ENDCOM;
import static com.osgi.example1.zipfs.ZipConstants.ENDHDR;
import static com.osgi.example1.zipfs.ZipConstants.ENDOFF;
import static com.osgi.example1.zipfs.ZipConstants.ENDSIG;
import static com.osgi.example1.zipfs.ZipConstants.ENDSIZ;
import static com.osgi.example1.zipfs.ZipConstants.ENDSUB;
import static com.osgi.example1.zipfs.ZipConstants.ENDTOT;
import static com.osgi.example1.zipfs.ZipConstants.END_MAXLEN;
import static com.osgi.example1.zipfs.ZipConstants.EXTID_EXTT;
import static com.osgi.example1.zipfs.ZipConstants.EXTID_NTFS;
import static com.osgi.example1.zipfs.ZipConstants.EXTID_ZIP64;
import static com.osgi.example1.zipfs.ZipConstants.EXTSIG;
import static com.osgi.example1.zipfs.ZipConstants.FLAG_DATADESCR;
import static com.osgi.example1.zipfs.ZipConstants.FLAG_EFS;
import static com.osgi.example1.zipfs.ZipConstants.LG;
import static com.osgi.example1.zipfs.ZipConstants.LL;
import static com.osgi.example1.zipfs.ZipConstants.LOCCRC;
import static com.osgi.example1.zipfs.ZipConstants.LOCEXT;
import static com.osgi.example1.zipfs.ZipConstants.LOCFLG;
import static com.osgi.example1.zipfs.ZipConstants.LOCHDR;
import static com.osgi.example1.zipfs.ZipConstants.LOCHOW;
import static com.osgi.example1.zipfs.ZipConstants.LOCLEN;
import static com.osgi.example1.zipfs.ZipConstants.LOCNAM;
import static com.osgi.example1.zipfs.ZipConstants.LOCSIG;
import static com.osgi.example1.zipfs.ZipConstants.LOCSIZ;
import static com.osgi.example1.zipfs.ZipConstants.LOCTIM;
import static com.osgi.example1.zipfs.ZipConstants.LOCVER;
import static com.osgi.example1.zipfs.ZipConstants.METHOD_DEFLATED;
import static com.osgi.example1.zipfs.ZipConstants.METHOD_STORED;
import static com.osgi.example1.zipfs.ZipConstants.READBLOCKSZ;
import static com.osgi.example1.zipfs.ZipConstants.SH;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_ENDHDR;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_ENDOFF;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_ENDSIG;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_ENDSIZ;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_ENDTOT;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_LOCHDR;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_LOCOFF;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_LOCSIG;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_MINVAL;
import static com.osgi.example1.zipfs.ZipConstants.ZIP64_MINVAL32;
import static com.osgi.example1.zipfs.ZipUtils.dosToJavaTime;
import static com.osgi.example1.zipfs.ZipUtils.javaToDosTime;
import static com.osgi.example1.zipfs.ZipUtils.javaToUnixTime;
import static com.osgi.example1.zipfs.ZipUtils.javaToWinTime;
import static com.osgi.example1.zipfs.ZipUtils.toDirectoryPath;
import static com.osgi.example1.zipfs.ZipUtils.toRegexPattern;
import static com.osgi.example1.zipfs.ZipUtils.unixToJavaTime;
import static com.osgi.example1.zipfs.ZipUtils.winToJavaTime;
import static com.osgi.example1.zipfs.ZipUtils.writeBytes;
import static com.osgi.example1.zipfs.ZipUtils.writeInt;
import static com.osgi.example1.zipfs.ZipUtils.writeLong;
import static com.osgi.example1.zipfs.ZipUtils.writeShort;
...
public class ZipFileSystem extends FileSystem {
	...
	private void sync() throws IOException {
		...
		/*
		 * if (isOpen) { ch = zfpath.newByteChannel(READ); // re-fresh "ch" and "cen" cen = initCEN(); }
		 */
	...
	public static void zerror(String msg) {
