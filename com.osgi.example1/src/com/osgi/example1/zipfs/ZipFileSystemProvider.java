...
public class ZipFileSystemProvider extends FileSystemProvider {
	...
	protected Map<Path, ZipFileSystem> filesystems = new HashMap<>();

	public ZipFileSystemProvider() {
	}

	public ZipFileSystemProvider(FileSystemProvider defaultProvider) {
		System.out.println("ZipFileSystemProvider() defaultProvider = " + defaultProvider);
	...
	public static ZipPath toZipPath(Path path) {
		if (path == null) {
	 ...
	 * @throws IOException
	 */
	public void removeFileSystem(Path zfpath, ZipFileSystem zfs) throws IOException {
		synchronized (filesystems) {
