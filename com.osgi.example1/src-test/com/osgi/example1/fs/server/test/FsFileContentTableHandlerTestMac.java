...
public class FsFileContentTableHandlerTestMac {
	...
	public void test001_writeFileContent_Postgres_mac() {
		...
		try {
			...
			File file5 = new File("/Users/oceaneuropa/Downloads/test/source/BW6 Refactoring.docx");
	...
	public void test005_readFileContent_Postgres_mac() {
		...
		try {
			...
			File file5 = new File("/Users/oceaneuropa/Downloads/test/target/BW6 Refactoring.docx");
