...
public class LocalFileSystemTest {
	...
	public void testDeleteFiles() throws IOException {
		...
		if (fs.exists(file1)) {
			...
			if (succeed) {
				...
				System.out.println(file1.getName() + " --- failed to delete.");
			}
		} else {
		...
		if (fs.exists(file2)) {
			...
			if (succeed) {
				...
				System.out.println(file2.getName() + " --- failed to delete.");
			}
		} else {
		...
		if (fs.exists(file3)) {
			...
			if (succeed) {
				...
				System.out.println(file3.getName() + " --- failed to delete.");
			}
		} else {
		...
		if (fs.exists(file6)) {
			...
			if (succeed) {
				...
				System.out.println(file6.getName() + " --- failed to delete.");
			}
		} else {
			System.out.println(file6.getName() + " does not exist.");
		}
		...
		System.out.println();
		System.out.println(dirPath2.getName() + ":");
	...
	public void testDeleteDir() throws IOException {
		...
		if (fs.exists(dirPath1)) {
			...
			if (succeed) {
				System.out.println(dirPath1.getName() + " is deleted.");
			} else {
				System.out.println(dirPath1.getName() + " --- failed to delete.");
			}
		} else {
			System.out.println(dirPath1.getName() + " does not exist.");
		}
		...
		if (fs.exists(dirPath2)) {
			...
			if (succeed) {
				System.out.println(dirPath2.getName() + " is deleted.");
			} else {
				System.out.println(dirPath2.getName() + " --- failed to delete.");
			}
		} else {
			System.out.println(dirPath2.getName() + " does not exist.");
		}
	...
	public void testCopyFileToFile() throws IOException {
		...
		fs.copyLocalFileToFile(localFile1, new Path(destDirPath, localFile1.getName()));
		fs.copyLocalFileToFile(localFile2, new Path(destDirPath, localFile2.getName()));
	...
	public void testCopyFileToDir() throws IOException {
		...
		fs.copyLocalFileToDirectory(localFile1, destDirPath);
		fs.copyLocalFileToDirectory(localFile2, destDirPath);
	...
	public void testCopyDirToDir1() throws IOException {
		...
		fs.copyLocalDirectoryToDirectory(localDir, destDirPath, true);
	...
	public void testCopyDirToDir2() throws IOException {
		...
		fs.copyLocalDirectoryToDirectory(localDir, destDirPath, false);
