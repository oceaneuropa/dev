 ...
 * 
 */
public class AppStoreWebServiceApplication extends AbstractResourceConfigApplication {

	protected static Logger LOG = LoggerFactory.getLogger(AppStoreWebServiceApplication.class);
	 ...
	 * @param service
	 */
	public AppStoreWebServiceApplication(final BundleContext bundleContext, final AppStoreService service) {
