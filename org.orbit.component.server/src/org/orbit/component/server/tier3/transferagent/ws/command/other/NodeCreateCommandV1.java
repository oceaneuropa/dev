package org.orbit.component.server.tier3.transferagent.ws.command.other;
...
public class NodeCreateCommandV1 extends AbstractTransferAgentCommandV1 {
	 ...
	 * @param request
	 */
	public NodeCreateCommandV1(TransferAgentService service, Request request) {
	...
	public ICommandResult execute(CommandContext context) throws CommandException {
		...
		try {
			...
			INode node = this.service.getNodeWorkspace().getFolder(nodeFullpath, INode.class);
