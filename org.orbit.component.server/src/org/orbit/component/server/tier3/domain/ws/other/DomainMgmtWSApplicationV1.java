...
import org.orbit.component.server.tier3.domain.ws.DomainMgmtWSMachinesResource;
import org.orbit.component.server.tier3.domain.ws.DomainMgmtWSNodesResource;
import org.orbit.component.server.tier3.domain.ws.DomainMgmtWSServiceResource;
import org.orbit.component.server.tier3.domain.ws.DomainMgmtWSTransferAgentsResource;
...
public class DomainMgmtWSApplicationV1 extends AbstractApplication {
	...
	public Set<Class<?>> getClasses() {
		...
		// resources
		classes.add(DomainMgmtWSServiceResource.class);
		classes.add(DomainMgmtWSMachinesResource.class);
		classes.add(DomainMgmtWSTransferAgentsResource.class);
		classes.add(DomainMgmtWSNodesResource.class);
