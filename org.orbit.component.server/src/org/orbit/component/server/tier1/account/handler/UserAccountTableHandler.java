...
public class UserAccountTableHandler implements DatabaseTableAware {
	 ...
	 * @throws SQLException
	 */
	public UserAccountRTO registerUserAccount(Connection conn, String userId, String password, String email, String firstName, String lastName, String phone, Date creationTime, Date lastUpdateTime) throws SQLException {
