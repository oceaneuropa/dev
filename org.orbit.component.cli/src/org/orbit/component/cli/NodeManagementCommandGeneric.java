...
public class NodeManagementCommandGeneric {

	protected static Logger LOG = LoggerFactory.getLogger(NodeManagementCommandGeneric.class);
	...
	public void start(final BundleContext bundleContext) {
		...
		OSGiServiceUtil.register(bundleContext, NodeManagementCommandGeneric.class.getName(), this, props);
	}

	public void stop(final BundleContext bundleContext) {
		OSGiServiceUtil.unregister(NodeManagementCommandGeneric.class.getName(), this);
	}

	protected NodeManagementClient getTransferAgent(String url) {
	...
	public void ping( //
		...
		try {
			NodeManagementClient transferAgent = getTransferAgent(url);
