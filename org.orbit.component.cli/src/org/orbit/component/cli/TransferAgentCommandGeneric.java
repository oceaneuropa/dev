...
public class TransferAgentCommandGeneric {

	protected static Logger LOG = LoggerFactory.getLogger(TransferAgentCommandGeneric.class);
	...
	public void start(final BundleContext bundleContext) {
		...
		OSGiServiceUtil.register(bundleContext, TransferAgentCommandGeneric.class.getName(), this, props);
	}

	public void stop(final BundleContext bundleContext) {
		OSGiServiceUtil.unregister(TransferAgentCommandGeneric.class.getName(), this);
	}
