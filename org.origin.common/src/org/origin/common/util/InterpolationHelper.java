...
public class InterpolationHelper {
	 ...
	 *            the property set to perform substitution on
	 * @param callback
	 *            the callback to obtain substitution values
	 * @param defaultsToEmptyString
	 ...
	 * <tt>${&lt;prop-name&gt;}</tt>, where <tt>&lt;prop-name&gt;</tt> refers to either a configuration property or a system property, then the
	 * corresponding property value is substituted for the variable placeholder. Multiple variable placeholders may exist in the specified value as
	 * well as nested variable placeholders, which are substituted from inner most to outer most. Configuration properties override system properties.
	 * </p>
	 *
	 * @param val
