...
import org.origin.common.thread.ThreadPoolUtils;
 ...
 *
 */
public class ThreadPoolTimerV1 {

	protected static Logger LOG = LoggerFactory.getLogger(ThreadPoolTimerV1.class);
	 ...
	 * @param name
	 */
	public ThreadPoolTimerV1(String name) {
		this.name = name;
	}
	 ...
	 * @param runnable
	 */
	public ThreadPoolTimerV1(String name, Runnable runnable) {
		if (runnable == null) {
