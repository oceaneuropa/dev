...
public class ListenerList {
	...
	/**
	 * The list of listeners. Initially empty but initialized to an array of size capacity the first time a listener is added. Maintains invariant: listeners !=
	 * null
	 */
	...
	/**
	 * Adds a listener to this list. This method has no effect if the <a href="ListenerList.html#same">same</a> listener is already registered.
	 * 
	 * @param listener
	...
	/**
	 * Returns an array containing all the registered listeners. The resulting array is unaffected by subsequent adds or removes. If there are no listeners
	 * registered, the result is an empty array. Use this method when notifying listeners, so that any modifications to the listener list during the
	...
	/**
	 * Removes a listener from this list. Has no effect if the <a href="ListenerList.html#same">same</a> listener was not already registered.
	 *
	 * @param listener
