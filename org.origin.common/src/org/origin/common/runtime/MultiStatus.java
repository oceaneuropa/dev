...
public class MultiStatus extends Status {
	...
	/**
	 * Adds all of the children of the given status to this multi-status. Does nothing if the given status has no children (which includes the case
	...
	/**
	 * Merges the given status into this multi-status. Equivalent to <code>add(status)</code> if the given status is not a multi-status. Equivalent to
	 * addAll(status) if the given status is a multi-status.
	 *
	 * @param status
