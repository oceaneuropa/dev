...
public class IndexItemAwareLoadBalanceResource<S> extends LoadBalanceResourceImpl<S> {
	 ...
	 * @param indexItem
	 */
	public IndexItemAwareLoadBalanceResource(S service, IndexItem indexItem) {
		super(service);
		if (indexItem == null) {
