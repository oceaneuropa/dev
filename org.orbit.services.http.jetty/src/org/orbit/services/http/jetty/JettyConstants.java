...
/**
 * Configuration constants for JettyConfigurator.
 * 
 */
public interface JettyConstants {
	 ...
	 * (full qualified name of the class that implements <code>org.eclipse.equinox.http.jetty.JettyCustomizer</code> and has a public no-arg constructor; the
	 * class must be supplied via a fragment to this bundle's classpath)</code>
	 */
