...
public class ConfigRegistryWSApplicationSwitcher extends AbstractJerseyWSApplicationSwitcher {
	 ...
	 * @param factory
	 */
	public ConfigRegistryWSApplicationSwitcher(String contextRoot, Switcher<URI> switcher, WSClientFactory factory) {
