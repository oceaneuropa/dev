...
public class UserRegistryWSApplicationSwitcher extends AbstractJerseyWSApplicationSwitcher {
	 ...
	 * @param factory
	 */
	public UserRegistryWSApplicationSwitcher(String contextRoot, Switcher<URI> switcher, WSClientFactory factory) {
