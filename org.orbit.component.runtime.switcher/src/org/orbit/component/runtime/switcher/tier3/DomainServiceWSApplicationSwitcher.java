...
public class DomainServiceWSApplicationSwitcher extends AbstractJerseyWSApplicationSwitcher {
	 ...
	 * @param factory
	 */
	public DomainServiceWSApplicationSwitcher(String contextRoot, Switcher<URI> switcher, WSClientFactory factory) {
