...
public class SwitchersCommand {

	protected static Logger LOG = LoggerFactory.getLogger(SwitchersCommand.class);
	...
	public void start(BundleContext bundleContext) {
		...
		OSGiServiceUtil.register(bundleContext, SwitchersCommand.class.getName(), this, props);
	}
	...
	public void stop(BundleContext bundleContext) {
		...
		OSGiServiceUtil.unregister(SwitchersCommand.class.getName(), this);
	}
