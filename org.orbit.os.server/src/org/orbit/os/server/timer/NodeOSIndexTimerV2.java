...
public class NodeOSIndexTimerV2 extends ServiceIndexTimerImplV2<IndexProvider, NodeOS, IndexItem> implements ServiceIndexTimerV2<IndexProvider, NodeOS, IndexItem> {

	/**
	 * 
	 * @param indexProvider
	 */
	public NodeOSIndexTimerV2(IndexProvider indexProvider) {
	...
	@Override
	public IndexItem getIndex(IndexProvider indexProvider, NodeOS service) throws IOException {
	...
	@Override
	public IndexItem addIndex(IndexProvider indexProvider, NodeOS service) throws IOException {
	...
	@Override
	public void updateIndex(IndexProvider indexProvider, NodeOS service, IndexItem indexItem) throws IOException {
