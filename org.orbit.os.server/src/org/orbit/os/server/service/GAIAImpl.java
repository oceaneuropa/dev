...
public class GAIAImpl implements GAIA {
	...
	public static final String OS_NAME = "GAIA";
	...
	public String getNamespace() {
		String namespace = getProperty(Constants.GAIA_NAMESPACE);
		return namespace;
	}
	...
	public synchronized void updateProperties(Map<Object, Object> configProps) {
		...
		System.out.println(Constants.GAIA_NAMESPACE + " = " + namespace);
		System.out.println(Constants.GAIA_NAME + " = " + name);
		System.out.println(Constants.GAIA_HOST_URL + " = " + hostURL);
		System.out.println(Constants.GAIA_CONTEXT_ROOT + " = " + contextRoot);
	...
	public synchronized void start() {
		...
		PropertyUtil.loadProperty(this.bundleContext, configProps, Constants.GAIA_NAMESPACE);
