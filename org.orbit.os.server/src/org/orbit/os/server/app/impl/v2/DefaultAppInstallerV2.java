...
public class DefaultAppInstallerV2 implements AppInstaller {

	public static final String ID = "DefaultAppInstallerV2";

	public static DefaultAppInstallerV2 INSTANCE = null;

	public static DefaultAppInstallerV2 getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new DefaultAppInstallerV2();
		}
		return INSTANCE;
	}
