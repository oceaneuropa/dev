...
import org.orbit.platform.runtime.programs.manifest.ManifestReader;
import org.orbit.platform.runtime.programs.manifest.ManifestWriter;
...
public class AppManifestUtil {
	...
	public static ProgramManifest getAppManifest(Bundle bundle) {
		...
		if (bundle != null) {
			URL url = null;
			try {
				url = bundle.getResource(PlatformConstants.APP_MANIFEST_FULLPATH);
	...
	public static ProgramManifest getManifestFromAppFolder(File appFolder) {
		ProgramManifest appManifest = null;
		File appManifestFile = new File(appFolder, PlatformConstants.APP_MANIFEST_FULLPATH);
