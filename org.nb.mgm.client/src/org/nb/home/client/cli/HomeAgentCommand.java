...
public class HomeAgentCommand implements Annotated {
	 ...
	 * @param bundleContext
	 */
	public HomeAgentCommand(BundleContext bundleContext) {
	...
	public void start() {
		...
		OSGiServiceUtil.register(this.bundleContext, HomeAgentCommand.class.getName(), this, props);
	...
	public void stop() {
		...
		OSGiServiceUtil.unregister(HomeAgentCommand.class.getName(), this);
