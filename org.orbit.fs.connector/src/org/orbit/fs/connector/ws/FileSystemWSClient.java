...
public class FileSystemWSClient extends AbstractWSClient {
	 ...
	 * @param config
	 */
	public FileSystemWSClient(ClientConfiguration config) {
		super(config);
	}
	 ...
	 */
	public FilePath[] listRoots() throws ClientException {
	...
	public FilePath[] listFiles(FilePath parent) throws ClientException {
		...
		try {
			...
			if (responseItems != null) {
				for (Map<String, Object> responseItem : responseItems) {
					FilePath path = toPath(responseItem);
					if (path != null) {
						paths.add(path);
					}
				}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public FileMetadata getFileMetadata(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	protected <T> T getFileAttribute(FilePath path, String attribute, Class<T> clazz) throws ClientException {
		T result = null;
	 ...
	 * @throws ClientException
	 */
	public boolean isDirectory(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean isHidden(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean exists(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean canExecute(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean canRead(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean canWrite(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public long getLength(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public long getLastModified(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean mkdirs(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean createNewFile(FilePath path) throws ClientException {
	 ...
	 * @throws ClientException
	 */
	public boolean delete(FilePath path) throws ClientException {
		WebTarget target = getRootPath().path("metadata").queryParam("path", path.getPathString());
		try {
			Builder builder = target.request(MediaType.APPLICATION_JSON);
	 ...
	 * @throws IOException
	 */
	public boolean uploadInputStreamToFsFile(InputStream input, FilePath destFilePath) throws ClientException, IOException {
		try {
	 ...
	 * @throws IOException
	 */
	public boolean uploadFileToFsFile(File localFile, FilePath destFilePath) throws ClientException, IOException {
		// Check source file
		if (!localFile.exists()) {
	 ...
	 * @throws IOException
	 */
	public boolean uploadFileToFsDirectory(File localFile, FilePath destDirPath) throws ClientException, IOException {
		FilePath destFilePath = new FilePath(destDirPath, localFile.getName());
	 ...
	 * @throws IOException
	 */
	public boolean uploadDirectoryToFsDirectory(File localDir, FilePath destDirPath, boolean includingSourceDir) throws ClientException, IOException {
	 ...
	 * @throws ClientException
	 */
	protected boolean doUploadDirectoryToFsDirectory(File localFile, FilePath destDirPath, List<File> encounteredFiles) throws IOException {
		...
		if (localFile.isDirectory()) {
			FilePath newDestDirPath = new FilePath(destDirPath, localFile.getName());
			try {
	 ...
	 * @throws IOException
	 */
	public boolean downloadFsFileToOutputStream(FilePath sourceFilePath, OutputStream output) throws ClientException, IOException {
		// Check source
	 ...
	 * @throws IOException
	 */
	public boolean downloadFsFileToFile(FilePath sourceFilePath, File destLocalFile) throws ClientException, IOException {
		// Check source
		if (sourceFilePath.isRoot()) {
			throw new IOException("Source path '" + sourceFilePath.getPathString() + "' is not a file.");
		}
	 ...
	 * @throws IOException
	 */
	public boolean downloadFsFileToDirectory(FilePath sourceFilePath, File destLocalDir) throws ClientException, IOException {
		// Check source
		if (sourceFilePath.isRoot()) {
			throw new IOException("Source path '" + sourceFilePath.getPathString() + "' is not a file.");
		}
	 ...
	 * @throws ClientException
	 */
	public boolean downloadFsDirectoryToDirectory(FilePath sourceDirPath, File destLocalDir, boolean includingSourceDir) throws ClientException, IOException {
		// Check source
		...
		List<FilePath> encounteredPaths = new ArrayList<FilePath>();
		FilePath[] memberPaths = listFiles(sourceDirPath);
	 ...
	 * @throws IOException
	 */
	protected void doDownloadPathToDirectory(FilePath path, File destLocalDir, List<FilePath> encounteredPaths) throws ClientException, IOException {
		...
		if (isDirectory(path)) {
			...
			FilePath[] memberPaths = listFiles(path);
			for (FilePath memberPath : memberPaths) {
	 ...
	 * @return
	 */
	protected FilePath toPath(Map<String, Object> responseItem) {
		FilePath path = null;
		if (responseItem != null) {
			Object pathString = responseItem.get("pathString");
			if (pathString != null) {
				path = new FilePath(pathString.toString());
			}
		}
		return path;
	}
