 ...
 * 
 * <p>
 * The client of this output stream can write the content of a file to it, while the upload keeps reading data from it (through a input that is connected to the output) and uploading the data to
 * remote server.
 * 
