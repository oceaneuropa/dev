...
public class TransferAgentConnectorAdapterV1 {

	protected static Logger LOG = LoggerFactory.getLogger(TransferAgentConnectorAdapterV1.class);

	protected ServiceTracker<ServiceConnector<NodeControlClient>, ServiceConnector<NodeControlClient>> serviceTracker;
	protected String connectorId;

	public TransferAgentConnectorAdapterV1() {
