...
public class AppManifestUtil {
	 ...
	 * @return
	 */
	public static AppManifest getAppManifest(Bundle bundle) {
	 ...
	 * @return
	 */
	public static AppManifest getManifestFromAppFolder(File appFolder) {
		AppManifest appManifest = null;
	 ...
	 * @return
	 */
	public static AppManifest loadManifes(File file) {
	 ...
	 * @return
	 */
	public static AppManifest loadManifes(Path path) {
		AppManifest manifest = null;
		ManifestReader reader = new ManifestReader();
		InputStream input = null;
		try {
	 ...
	 * @return
	 */
	public static AppManifest loadManifes(InputStream input) {
		AppManifest manifest = null;
		ManifestReader reader = new ManifestReader();
		try {
			manifest = reader.read(input);
	 ...
	 * @param file
	 */
	public static void saveManifest(AppManifest manifest, File file) {
	 ...
	 * @throws IOException
	 */
	public static void saveManifest(AppManifest manifest, Path manifestPath) throws IOException {
	 ...
	 * @param ouput
	 */
	public static void saveManifest(AppManifest manifest, OutputStream ouput) {
		ManifestWriter writer = new ManifestWriter();
		try {
