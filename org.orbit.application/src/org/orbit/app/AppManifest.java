...
public class AppManifest {
	 ...
	 * @param properties
	 */
	public AppManifest(String id, String version, String type, String name, String description, BundleManifest[] bundles, String[] classPaths, Properties properties) {
		this.id = id;
