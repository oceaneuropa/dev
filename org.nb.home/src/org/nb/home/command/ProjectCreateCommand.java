...
public class ProjectCreateCommand extends AbstractCommand {
	...
	public CommandResult execute(CommandContext context) throws CommandException {
		...
		// if (doSave) {
		// ProjectConfigFileCache projectConfigFileCache = WorkingCopyUtil.getWorkingCopy(projectConfigFile, ProjectConfigFileCacheFactory.class,
		// ProjectConfigFileCache.class);
