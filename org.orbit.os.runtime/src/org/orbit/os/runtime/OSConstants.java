...
public class OSConstants {
	...
	// ----------------------------------------------------------------------------------------
	// index item values
	public static String OS_INDEXER_ID = "os.indexer"; // index provider id for OS
	public static String OS_TYPE = "OS"; // type of index item for OS

	// index item properties
	public static String OS_PROGRAM_NAME = "os.program.name";
	public static String OS_PROGRAM_VERSION = "os.program.version";
	public static String OS_NAME = "os.name";
	public static String OS_HOST_URL = "os.host.url";
	public static String OS_CONTEXT_ROOT = "os.context_root";
	public static String OS_HOME = "os.home";
