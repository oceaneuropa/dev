...
<body>
	...
	<div class="main_div01">
		...
		<div class="top_tools_div01">
			...
			-->
			<a class="button01" href="javascript:addPlatform()">Add</a>
			<a class="button01" href="javascript:deletePlatforms()">Delete</a>
			<a class="button01" href="<%=contextRoot + "/domain/platform?machineId=" + machineId%>">Refresh</a>
		</div>
		<table class="main_table01">
			...
			<tr>
				...
				<td class="td1">
					<a href="javascript:changePlatform('<%=id%>', '<%=name%>', '<%=hostURL%>', '<%=currContextRoot%>')">Change</a> | 
					<a href="javascript:deletePlatform('<%=contextRoot + "/domain/platformdelete"%>', '<%=machineId%>', '<%=id%>')">Delete</a>
				</td>
			</tr>
			<%
				}
	...
	<div class="dialog_title_div01">Add Platform</div>
		<form method="post" action="<%=contextRoot + "/domain/platformadd"%>">
		<input type="hidden" name="machineId" value="<%=machineId%>">
		...
		<div class="dialog_button_div01">
			<button id="okAddPlatform" type="submit">OK</button>
			<button id="cancelAddPlatform" type="reset">Cancel</button> 
		</div>
		</form>
	</dialog>
	...
	<div class="dialog_title_div01">Change Platform</div>
		<form method="post" action="<%=contextRoot + "/domain/platformupdate"%>">
		<input type="hidden" name="machineId" value="<%=machineId%>">
		<div class="dialog_main_div01">
			<table class="dialog_table01">
				<tr>
