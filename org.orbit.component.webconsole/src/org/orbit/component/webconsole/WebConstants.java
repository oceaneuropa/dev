...
public class WebConstants {
	...
	public static String SESSION__FULLNAME = "fullname";
	public static String SESSION__TOKEN_TYPE = "token_type";
	public static String SESSION__ACCESS_TOKEN = "access_token";
