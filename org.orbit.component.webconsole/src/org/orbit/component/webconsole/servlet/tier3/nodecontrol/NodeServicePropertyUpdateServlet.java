...
public class NodeServicePropertyUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!machineId.isEmpty() && !parentPlatformId.isEmpty() && !nodeId.isEmpty() && !name.isEmpty()) {
			try {
				...
				if (serviceInfo != null) {
					succeed = PlatformClientsUtil.INSTANCE.updateServiceProperty(platformClientResolver, parentPlatformId, nodeId, sid, oldName, name, value);
				}
