 ...
 *
 */
public class CreateNewAccountPage extends HttpServlet {

	private static final long serialVersionUID = -1412386864914553909L;

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String contextRoot = getServletConfig().getInitParameter(WebConstants.ORIGIN__WEB_CONSOLE_CONTEXT_ROOT);
		String message = "";
		...
		request.getRequestDispatcher(contextRoot + "/views/originCreateNewAccount.jsp").forward(request, response);
	}
