 ...
 * 1001			create_index_item 		{indexProviderId="origin.index.provider", namespace="tns1", name="name1", properties={p1=v1, p2=v2}, lastUpdateTime="05-20-2016 13:53:30"}		delete_index_item		{indexItemId=1}																																					{currentTime}
 * 1002			create_index_item 		{indexProviderId="origin.index.provider", namespace="tns1", name="name2", properties={p3=v3, p4=v4}, lastUpdateTime="05-20-2016 14:02:20"}		delete_index_item		{indexItemId=2}																																					{currentTime}
 ...
 * 1005			delete_index_item 		{indexItemId=1}																																	create_index_item		{indexitemid=1, indexproviderid="origin.index.provider", namespace="tns1", name="name1", properties={p1=v1b, p2=v2b}, lastUpdateTime="05-20-2016 14:05:05"}		{currentTime}
 * 1006			delete_index_item 		{indexItemId=2}																																	create_index_item		{indexitemid=2, indexproviderid="origin.index.provider", namespace="tns1", name="name2", properties={p3=v3b, p4=v4b}, lastUpdateTime="05-20-2016 14:06:05"}		{currentTime}
 * --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * 
