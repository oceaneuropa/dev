...
public class AppManifestImpl implements AppManifest {
	 ...
	 * @param dto
	 */
	public AppManifestImpl(AppManifestDTO dto) {
		...
		this.manifestString = dto.getAppManifest();
		this.fileName = dto.getFileName();
		this.description = dto.getDescription();
		this.dateCreated = new Date(dto.getDateCreated());
		this.dateModified = new Date(dto.getDateModified());
	}
