...
public class Extensions extends ProgramExtensions {
	...
	protected void createConnectorExtensions() {
		...
		InterfaceDescription desc1 = new InterfaceDescription(IConnectorActivator.class, UserRegistryConnector.class);
		extension1.addInterface(desc1);
		addExtension(extension1);

		// Auth connector
		Extension extension2 = new Extension(typeId, AuthConnector.ID, "Auth Connector", "Auth connector description");
		InterfaceDescription desc2 = new InterfaceDescription(IConnectorActivator.class, AuthConnector.class);
		...
		InterfaceDescription desc3 = new InterfaceDescription(IConnectorActivator.class, ConfigRegistryConnector.class);
		...
		InterfaceDescription desc4 = new InterfaceDescription(IConnectorActivator.class, AppStoreConnector.class);
		...
		InterfaceDescription desc5 = new InterfaceDescription(IConnectorActivator.class, DomainManagementConnector.class);
		...
		InterfaceDescription desc6 = new InterfaceDescription(IConnectorActivator.class, NodeControlConnector.class);
		...
		InterfaceDescription desc7 = new InterfaceDescription(IConnectorActivator.class, MissionControlConnector.class);
	...
	protected void createCommandExtensions() {
		...
		InterfaceDescription desc2 = new InterfaceDescription(ICommandActivator.class, AuthCommand.class);
		extension2.addInterface(desc2);
		addExtension(extension2);
		...
		InterfaceDescription desc3 = new InterfaceDescription(ICommandActivator.class, UserRegistryCommand.class);
		extension3.addInterface(desc3);
		addExtension(extension3);
		...
		InterfaceDescription desc4 = new InterfaceDescription(ICommandActivator.class, AppStoreCommand.class);
		extension4.addInterface(desc4);
		addExtension(extension4);
		...
		InterfaceDescription desc5 = new InterfaceDescription(ICommandActivator.class, DomainManagementCommand.class);
		extension5.addInterface(desc5);
		addExtension(extension5);
		...
		InterfaceDescription desc6 = new InterfaceDescription(ICommandActivator.class, NodeControlCommand.class);
		extension6.addInterface(desc6);
		addExtension(extension6);
		...
		InterfaceDescription desc7 = new InterfaceDescription(ICommandActivator.class, NodeControlCommandGeneric.class);
		extension7.addInterface(desc7);
		addExtension(extension7);
		...
		InterfaceDescription desc8 = new InterfaceDescription(ICommandActivator.class, MissionControlCommand.class);
