...
public class Extensions extends ProgramExtensions {
	...
	protected void createDownloaderExtensions() {
		Extension extension1 = new Extension(Downloader.EXTENSION_TYPE_ID, AppStoreDownloader.ID, "AppStore Downloader", "Default downloader to download apps from the app store");
