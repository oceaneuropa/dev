...
public class UserRegistryConnectorImplV2 extends ServiceConnectorImpl<UserRegistry> implements UserRegistryConnector {
	 ...
	 * @param indexService
	 */
	public UserRegistryConnectorImplV2(IndexService indexService) {
	...
	protected UserRegistry createService(Map<String, Object> properties) {
		try {
			...
			String indexItemId = properties.get(OriginConstants.INDEX_ITEM_ID).toString(); // "index_item_id"
