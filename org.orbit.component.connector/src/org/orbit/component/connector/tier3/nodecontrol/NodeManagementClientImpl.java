...
public class NodeManagementClientImpl extends ServiceClientImpl<NodeManagementClient, NodeManagementWSClient> implements NodeManagementClient {
	 ...
	 * @param properties
	 */
	public NodeManagementClientImpl(ServiceConnector<NodeManagementClient> connector, Map<String, Object> properties) {
	...
	@Override
	protected NodeManagementWSClient createWSClient(Map<String, Object> properties) {
		...
		return new NodeManagementWSClient(config);
	}
	...
	public boolean close() throws ClientException {
		...
		ServiceConnector<NodeManagementClient> connector = getAdapter(ServiceConnector.class);
		if (connector != null) {
	...
	protected void initClient() {
		...
		ClientConfiguration config = ClientConfiguration.create(realm, username, fullUrl);
		this.client = new NodeManagementWSClient(config);
	}
