...
public class DomainManagementCommandV1 implements Annotated {
	 ...
	 * @param bundleContext
	 */
	public DomainManagementCommandV1(BundleContext bundleContext) {
	...
	public void start() {
		...
		OSGiServiceUtil.register(this.bundleContext, DomainManagementCommandV1.class.getName(), this, props);
	...
	public void stop() {
		...
		OSGiServiceUtil.unregister(DomainManagementCommandV1.class.getName(), this);
