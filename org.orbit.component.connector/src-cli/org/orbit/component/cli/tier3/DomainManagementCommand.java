...
import org.orbit.component.model.tier3.domain.dto.DomainManagementResponseConverter;
...
public class DomainManagementCommand implements Annotated {
	...
	public void list_machine( //
		...
		try {
			...
			Response response = domainMgmt.sendRequest(request);
			MachineConfig resultMachineConfig = DomainManagementResponseConverter.getInstance().convertToMachineConfig(response);
	...
	public void list_tas( //
		...
		try {
			...
			TransferAgentConfig[] taConfigs = DomainManagementResponseConverter.getInstance().convertToTransferAgentConfigs(response);
	...
	public void list_ta( //
		...
		try {
			...
			Response response = domainMgmt.sendRequest(request);
			TransferAgentConfig resultTaConfig = DomainManagementResponseConverter.getInstance().convertToTransferAgentConfig(response);
	...
	public void list_nodes( //
		...
		try {
			...
			NodeConfig[] nodeConfigs = DomainManagementResponseConverter.getInstance().convertToNodeConfigs(response);
	...
	public void list_node( //
		...
		try {
			...
			Response response = domainMgmt.sendRequest(request);
			NodeConfig resultNodeConfig = DomainManagementResponseConverter.getInstance().convertToNodeConfig(response);
	...
	public void add_node( //
		...
		try {
			...
			Response response = domainMgmt.sendRequest(addNodeConfigRequest);
			if (response != null) {
				// System.out.println(response.getSimpleLabel());
				// if (response.getException() != null) {
				// response.getException().printStackTrace();
