...
public class RemoveConfigRegistryPropertiesWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.RemoveConfigRegistryPropertiesWSCommand";

	public RemoveConfigRegistryPropertiesWSCommand() {
