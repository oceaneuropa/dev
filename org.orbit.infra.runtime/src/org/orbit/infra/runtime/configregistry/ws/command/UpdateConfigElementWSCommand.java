...
public class UpdateConfigElementWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.UpdateConfigElementWSCommand";

	public UpdateConfigElementWSCommand() {
