...
public class SetConfigElementAttributesWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.SetConfigElementAttributesWSCommand";

	public SetConfigElementAttributesWSCommand() {
