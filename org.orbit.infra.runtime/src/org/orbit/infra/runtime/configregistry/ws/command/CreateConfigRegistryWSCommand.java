...
public class CreateConfigRegistryWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.CreateConfigRegistryWSCommand";

	public CreateConfigRegistryWSCommand() {
	...
	public Response execute(Request request) throws Exception {
		...
		ConfigRegistryDTO metadataDTO = RuntimeModelConverter.CONFIG_REGISTRY.toDTO(metadata);
