...
public class ConfigElementExistsWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.ConfigElementExistsWSCommand";

	public ConfigElementExistsWSCommand() {
