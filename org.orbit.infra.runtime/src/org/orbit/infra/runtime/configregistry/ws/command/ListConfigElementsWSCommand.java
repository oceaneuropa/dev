...
public class ListConfigElementsWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.ListConfigElementsWSCommand";

	public ListConfigElementsWSCommand() {
