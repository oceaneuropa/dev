...
public class UpdateConfigRegistryWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.UpdateConfigRegistryWSCommand";

	public UpdateConfigRegistryWSCommand() {
