...
public class GetConfigRegistryWSCommand extends AbstractInfraCommand<ConfigRegistryService> implements WSCommand {

	public static String ID = "org.orbit.infra.runtime.configregistry.GetConfigRegistryWSCommand";

	public GetConfigRegistryWSCommand() {
