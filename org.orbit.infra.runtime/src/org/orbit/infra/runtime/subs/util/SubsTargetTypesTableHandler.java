...
import org.orbit.infra.model.subs.impl.SubsTargetTypeImpl;
...
public class SubsTargetTypesTableHandler implements DatabaseTableAware {
	 ...
	 * @throws SQLException
	 */
	protected SubsTargetType toObject(ResultSet rs) throws SQLException {
		int id = rs.getInt("id");
		...
		return new SubsTargetTypeImpl(Integer.valueOf(id), type, name, dateCreated, dateModified);
	}
	 ...
	 * @throws SQLException
	 */
	public List<SubsTargetType> getTypes(Connection conn) throws SQLException {
		String querySQL = "SELECT * FROM " + getTableName() + " ORDER BY type ASC";
		ResultSetListHandler<SubsTargetType> handler = new ResultSetListHandler<SubsTargetType>() {
			@Override
	 ...
	 * @throws SQLException
	 */
	public SubsTargetType getType(Connection conn, String type) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public SubsTargetType createType(Connection conn, String type, String name) throws SQLException {
