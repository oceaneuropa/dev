...
public class InfraRelays {
	 ...
	 * @return
	 */
	public DataCastWSApplicationRelay createDataCastRelay(BundleContext bundleContext, Map<Object, Object> initProperties) {
		LOG.debug("createDataCastRelay()");
		...
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.ORBIT_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATACAST__RELAY_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATACAST__RELAY_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATACAST__RELAY_HOSTS);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATACAST__RELAY_URLS);

		final String hostURL = (String) properties.get(InfraConstants.ORBIT_HOST_URL);
		final String name = (String) properties.get(InfraConstants.DATACAST__RELAY_NAME);
		final String contextRoot = (String) properties.get(InfraConstants.DATACAST__RELAY_CONTEXT_ROOT);
		String hosts = (String) properties.get(InfraConstants.DATACAST__RELAY_HOSTS);
		String urls = (String) properties.get(InfraConstants.DATACAST__RELAY_URLS);

		LOG.debug("Properties:");
		LOG.debug("-----------------------------------------------------------------------------");
		LOG.debug(InfraConstants.ORBIT_HOST_URL + " = " + hostURL);
		LOG.debug(InfraConstants.DATACAST__RELAY_NAME + " = " + name);
		LOG.debug(InfraConstants.DATACAST__RELAY_CONTEXT_ROOT + " = " + hostURL);
		LOG.debug(InfraConstants.DATACAST__RELAY_HOSTS + " = " + contextRoot);
		LOG.debug(InfraConstants.DATACAST__RELAY_URLS + " = " + urls);
		LOG.debug("-----------------------------------------------------------------------------");
		...
		DataCastWSApplicationRelay relay = new DataCastWSApplicationRelay(webServiceAware, uriSwitcher);
		return relay;
	}
	 ...
	 * @return
	 */
	public DataTubeWSApplicationRelay createDataTubeRelay(BundleContext bundleContext, Map<Object, Object> initProperties) {
		LOG.debug("createDataTubeRelay()");
		...
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.ORBIT_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATATUBE__RELAY_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATATUBE__RELAY_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATATUBE__RELAY_HOSTS);
		PropertyUtil.loadProperty(bundleContext, properties, InfraConstants.DATATUBE__RELAY_URLS);

		final String hostURL = (String) properties.get(InfraConstants.ORBIT_HOST_URL);
		final String name = (String) properties.get(InfraConstants.DATATUBE__RELAY_NAME);
		final String contextRoot = (String) properties.get(InfraConstants.DATATUBE__RELAY_CONTEXT_ROOT);
		String hosts = (String) properties.get(InfraConstants.DATATUBE__RELAY_HOSTS);
		String urls = (String) properties.get(InfraConstants.DATATUBE__RELAY_URLS);

		LOG.debug("Properties:");
		LOG.debug("-----------------------------------------------------------------------------");
		LOG.debug(InfraConstants.ORBIT_HOST_URL + " = " + hostURL);
		LOG.debug(InfraConstants.DATATUBE__RELAY_NAME + " = " + name);
		LOG.debug(InfraConstants.DATATUBE__RELAY_CONTEXT_ROOT + " = " + contextRoot);
		LOG.debug(InfraConstants.DATATUBE__RELAY_HOSTS + " = " + hosts);
		LOG.debug(InfraConstants.DATATUBE__RELAY_URLS + " = " + urls);
		LOG.debug("-----------------------------------------------------------------------------");
		...
		DataTubeWSApplicationRelay relay = new DataTubeWSApplicationRelay(webServiceAware, uriSwitcher);
		return relay;
	}
