...
public class ListDataTubeConfigsCommand extends AbstractInfraCommand<DataCastService> implements WSCommand {
	...
	public Response execute(Request request) throws Exception {
		...
		if (dataTubeConfigs != null) {
			for (DataTubeConfig currDataTubeConfig : dataTubeConfigs) {
				DataTubeConfigDTO dataTubeConfigDTO = RuntimeModelConverter.DATA_CAST.toDTO(currDataTubeConfig);
