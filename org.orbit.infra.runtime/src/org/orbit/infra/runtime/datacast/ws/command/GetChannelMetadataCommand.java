...
public class GetChannelMetadataCommand extends AbstractDataCastCommand<DataCastService> implements WSCommand {
	...
	public Response execute(Request request) throws Exception {
		...
		if (hasChannelId) {
			...
			channelMetadata = dataCastService.getChannelMetadataById(channelId);

		} else if (hasName) {
			String name = request.getStringParameter("name");
			channelMetadata = dataCastService.getChannelMetadataByName(name);
		}
