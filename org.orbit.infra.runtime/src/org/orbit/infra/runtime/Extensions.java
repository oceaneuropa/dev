...
public class Extensions extends ProgramExtensions {
	...
	protected void createServiceActivatorExtensions() {
		...
		desc1.setInterfaceClass(ServiceActivator.class);
		desc1.setInterfaceObject(IndexServiceActivator.INSTANCE);
		desc1.setParameters( //
		...
		desc2.setInterfaceClass(ServiceActivator.class);
		desc2.setInterfaceObject(ChannelServiceActivator.INSTANCE);
		desc2.setParameters( //
		...
		desc3.setInterfaceClass(ServiceActivator.class);
		desc3.setInterfaceObject(IndexServiceRelayActivator.INSTANCE);
		desc3.setParameters( //
		...
		desc4.setInterfaceClass(ServiceActivator.class);
		desc4.setInterfaceObject(IndexServiceRelayActivator.INSTANCE);
		desc4.setParameters( //
