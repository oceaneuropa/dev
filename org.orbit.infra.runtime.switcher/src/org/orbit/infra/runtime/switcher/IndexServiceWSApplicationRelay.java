...
public class IndexServiceWSApplicationRelay extends WSApplicationRelay {
	 ...
	 * @param factory
	 */
	public IndexServiceWSApplicationRelay(String contextRoot, Switcher<URI> switcher, WSClientFactory factory) {
