 ...
 * 
 * 
 * This class implements a simple bundle that uses the bundle context to register an French language dictionary service with the OSGi framework. The
 * dictionary service interface is defined in a separate class file and is implemented by an inner class. This class is identical to the class in
