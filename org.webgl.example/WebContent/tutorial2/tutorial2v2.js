...
function start() {
	canvas = document.getElementById("glcanvas");
  	...
  	if (gl) {
    	...
    	// Initialize the shaders; this is where all the lighting for the vertices and so forth is established.
    	initShaders();
...
function initBuffers() {
	...
	squareVerticesBuffer = gl.createBuffer();
  	...
  	// Now create an array of vertices for the square. Note that the Z coordinate is always 0 here.
  	var vertices = [
        1.0,  1.0,  0.0,
       -1.0,  1.0,  0.0,
        1.0, -1.0,  0.0,
  	...
  	// We do this by creating a Float32Array from the JavaScript array, then use it to fill the current vertex buffer.
...
function drawScene() {
	...
	gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
  	...
  	// Draw the square by binding the array buffer to the square's vertices array, setting attributes, and pushing it to GL.
  	gl.bindBuffer(gl.ARRAY_BUFFER, squareVerticesBuffer);
