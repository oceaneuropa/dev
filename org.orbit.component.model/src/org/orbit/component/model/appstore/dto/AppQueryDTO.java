...
public class AppQueryDTO {
	 ...
	 * @param query
	 */
	public AppQueryDTO(AppQuery query) {
		this.appId = query.getAppId();
		this.namespace = query.getNamespace();
		this.categoryId = query.getCategoryId();
		this.name = query.getName();
		this.version = query.getVersion();
		this.description = query.getDescription();

		this.appId_oper = SQLWhereOperator.isEqual(query.getAppId_oper()) ? null : query.getAppId_oper();
		this.namespace_oper = SQLWhereOperator.isEqual(query.getNamespace_oper()) ? null : query.getNamespace_oper();
		this.categoryId_oper = SQLWhereOperator.isEqual(query.getCategoryId_oper()) ? null : query.getCategoryId_oper();
		this.name_oper = SQLWhereOperator.isEqual(query.getName_oper()) ? null : query.getName_oper();
		this.version_oper = SQLWhereOperator.isEqual(query.getVersion_oper()) ? null : query.getVersion_oper();
		this.description_oper = SQLWhereOperator.isEqual(query.getDescription_oper()) ? null : query.getDescription_oper();
	}
