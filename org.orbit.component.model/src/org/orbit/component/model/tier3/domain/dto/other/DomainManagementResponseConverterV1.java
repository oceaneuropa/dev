...
public class DomainManagementResponseConverterV1 {

	protected static DomainManagementResponseConverterV1 INSTANCE = new DomainManagementResponseConverterV1();

	public static DomainManagementResponseConverterV1 getInstance() {
		return INSTANCE;
	}
