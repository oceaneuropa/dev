package other.orbit.component.runtime.cli;
...
public class RelaysCommandV1 {

	protected static Logger LOG = LoggerFactory.getLogger(RelaysCommandV1.class);
	...
	public void start(BundleContext bundleContext) {
		...
		OSGiServiceUtil.register(bundleContext, RelaysCommandV1.class.getName(), this, props);
	}
	...
	public void stop(BundleContext bundleContext) {
		LOG.info("stop()");
		OSGiServiceUtil.unregister(RelaysCommandV1.class.getName(), this);
	}
