...
public class AuthRelayControl extends WSRelayControlImpl {

	public static AuthRelayControl INSTANCE = new AuthRelayControl();
	...
	public synchronized void start(BundleContext bundleContext, WSClientFactory factory, String hostURL, String contextRoot, List<URI> uriList) {
		...
		if (wsApp == null) {
			AuthWSApplicationDesc wsAppDesc = new AuthWSApplicationDesc(new WebServiceAwareImpl(null, null, contextRoot));
