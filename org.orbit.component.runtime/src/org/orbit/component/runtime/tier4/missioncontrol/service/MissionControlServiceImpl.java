...
public class MissionControlServiceImpl implements MissionControlService {
	...
	public void start(BundleContext bundleContext) {
		...
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_DRIVER);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_USERNAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_PASSWORD);
	...
	public synchronized void update(Map<Object, Object> properties) {
		...
		String jdbcDriver = (String) properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_DRIVER);
		String jdbcURL = (String) properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_URL);
		String jdbcUsername = (String) properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_USERNAME);
		String jdbcPassword = (String) properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_JDBC_PASSWORD);
	...
	public String getHostURL() {
		String hostURL = (String) this.properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_HOST_URL);
		if (hostURL != null) {
			return hostURL;
		}
	...
	public String getContextRoot() {
		String contextRoot = (String) this.properties.get(ComponentConstants.COMPONENT_MISSION_CONTROL_CONTEXT_ROOT);
		return contextRoot;
	}
