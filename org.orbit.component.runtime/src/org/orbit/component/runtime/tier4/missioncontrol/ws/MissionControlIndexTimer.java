...
public class MissionControlIndexTimer extends ServiceIndexTimer<MissionControlService> {
	...
	public IndexItem getIndex(IndexProvider indexProvider, MissionControlService service) throws IOException {
		...
		return indexProvider.getIndexItem(ComponentsConstants.MISSION_CONTROL_INDEXER_ID, ComponentsConstants.MISSION_CONTROL_TYPE, name);
	}
	...
	public IndexItem addIndex(IndexProvider indexProvider, MissionControlService service) throws IOException {
		...
		props.put(ComponentsConstants.MISSION_CONTROL_NAME, name);
		props.put(ComponentsConstants.MISSION_CONTROL_HOST_URL, hostURL);
		props.put(ComponentsConstants.MISSION_CONTROL_CONTEXT_ROOT, contextRoot);
		...
		return indexProvider.addIndexItem(ComponentsConstants.MISSION_CONTROL_INDEXER_ID, ComponentsConstants.MISSION_CONTROL_TYPE, name, props);
	}
	...
	public void updateIndex(IndexProvider indexProvider, MissionControlService service, IndexItem indexItem) throws IOException {
		...
		indexProvider.setProperties(ComponentsConstants.MISSION_CONTROL_INDEXER_ID, indexItemId, props);
	}
	...
	public void removeIndex(IndexProvider indexProvider, IndexItem indexItem) throws IOException {
		...
		indexProvider.removeIndexItem(ComponentsConstants.MISSION_CONTROL_INDEXER_ID, indexItemId);
	}
