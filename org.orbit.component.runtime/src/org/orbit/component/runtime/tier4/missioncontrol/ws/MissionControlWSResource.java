 ...
 * 
 * MissionControl web service resource.
 * 
 * {contextRoot} example: /orbit/v1/mission
 *
 ...
 * 
 */
@Secured(roles = { OrbitRoles.SYSTEM_COMPONENT, OrbitRoles.SYSTEM_ADMIN, OrbitRoles.MISSION_CONTROL_ADMIN })
@javax.ws.rs.Path("/")
@Produces(MediaType.APPLICATION_JSON)
public class MissionControlWSResource extends AbstractWSApplicationResource {

	@Inject
	public MissionControlService service;

	public MissionControlService getService() throws RuntimeException {
		if (this.service == null) {
			throw new RuntimeException("MissionControlService is not available.");
		}
		return this.service;
	}
