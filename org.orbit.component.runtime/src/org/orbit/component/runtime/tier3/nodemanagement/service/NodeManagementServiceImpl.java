...
import org.orbit.component.runtime.tier3.nodemanagement.util.TASetupUtil;
 ...
 *
 */
public class NodeManagementServiceImpl implements NodeManagementService, LifecycleAware {
	...
	public void start(BundleContext bundleContext) {
		...
		this.serviceRegistry = bundleContext.registerService(NodeManagementService.class, this, props);
	...
	public synchronized void update(Map<Object, Object> configProps) {
		...
		String name = (String) configProps.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_NAME);
		String hostURL = (String) configProps.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOST_URL);
		String contextRoot = (String) configProps.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_CONTEXT_ROOT);
		String home = (String) configProps.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOME);

		System.out.println();
		System.out.println("Config properties:");
		System.out.println("-----------------------------------------------------");
		System.out.println(OrbitConstants.ORBIT_HOST_URL + " = " + globalHostURL);
		System.out.println(OrbitConstants.COMPONENT_NODE_MANAGEMENT_NAME + " = " + name);
		System.out.println(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOST_URL + " = " + hostURL);
		System.out.println(OrbitConstants.COMPONENT_NODE_MANAGEMENT_CONTEXT_ROOT + " = " + contextRoot);
		System.out.println(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOME + " = " + home);
		System.out.println("-----------------------------------------------------");
		System.out.println();
	...
	public String getName() {
		String name = (String) this.properties.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_NAME);
		return name;
	}

	@Override
	public String getHostURL() {
		String hostURL = (String) this.properties.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOST_URL);
		if (hostURL != null) {
			return hostURL;
		}
	...
	public String getContextRoot() {
		String contextRoot = (String) this.properties.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_CONTEXT_ROOT);
		return contextRoot;
	}

	@Override
	public String getHome() {
		String home = (String) this.properties.get(OrbitConstants.COMPONENT_NODE_MANAGEMENT_HOME);
		return home;
	}
