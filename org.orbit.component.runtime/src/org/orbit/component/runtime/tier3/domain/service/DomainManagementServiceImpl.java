...
public class DomainManagementServiceImpl implements DomainManagementService {
	...
	public void start(BundleContext bundleContext) {
		...
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_JDBC_DRIVER);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_JDBC_URL);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_JDBC_USERNAME);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_DOMAIN_SERVICE_JDBC_PASSWORD);
	...
	// ------------------------------------------------------
	@Override
	public List<TransferAgentConfigRTO> getTransferAgentConfigs(String machineId) throws ServerException {
		checkMachineId(machineId);
	...
	@Override
	public TransferAgentConfigRTO getTransferAgentConfig(String machineId, String transferAgentId) throws ServerException {
		checkMachineId(machineId);
	...
	@Override
	public boolean transferAgentConfigExists(String machineId, String transferAgentId) throws ServerException {
		checkMachineId(machineId);
		checkTransferAgentId(transferAgentId);
	...
	@Override
	public boolean addTransferAgentConfig(String machineId, TransferAgentConfigRTO addTransferAgentRequest) throws ServerException {
	...
	@Override
	public boolean updateTransferAgentConfig(String machineId, TransferAgentConfigRTO updateTransferAgentRequest, List<String> fieldsToUpdate) throws ServerException {
	...
	@Override
	public boolean deleteTransferAgentConfig(String machineId, String transferAgentId) throws ServerException {
		checkMachineId(machineId);
		checkTransferAgentId(transferAgentId);
