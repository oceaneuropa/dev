...
public class DomainMgmtWSNodesResource extends AbstractWSApplicationResource {

	protected static Logger LOG = LoggerFactory.getLogger(DomainMgmtWSNodesResource.class);
