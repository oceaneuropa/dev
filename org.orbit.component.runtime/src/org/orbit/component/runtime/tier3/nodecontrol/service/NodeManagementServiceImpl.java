...
public class NodeManagementServiceImpl implements NodeManagementService {
	...
	public void start(BundleContext bundleContext) {
		...
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_TRANSFER_AGENT_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_TRANSFER_AGENT_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_TRANSFER_AGENT_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, OrbitConstants.COMPONENT_TRANSFER_AGENT_HOME);
	...
	public String getName() {
		String name = (String) this.properties.get(OrbitConstants.COMPONENT_TRANSFER_AGENT_NAME);
		return name;
	}

	@Override
	public String getHostURL() {
		String hostURL = (String) this.properties.get(OrbitConstants.COMPONENT_TRANSFER_AGENT_HOST_URL);
		if (hostURL != null) {
			return hostURL;
		}
	...
	public String getContextRoot() {
		String contextRoot = (String) this.properties.get(OrbitConstants.COMPONENT_TRANSFER_AGENT_CONTEXT_ROOT);
		return contextRoot;
	}

	@Override
	public String getHome() {
		String home = (String) this.properties.get(OrbitConstants.COMPONENT_TRANSFER_AGENT_HOME);
		return home;
	}
