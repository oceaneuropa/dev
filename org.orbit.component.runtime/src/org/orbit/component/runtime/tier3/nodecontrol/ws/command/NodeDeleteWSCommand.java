...
public class NodeDeleteWSCommand extends AbstractOrbitCommand<NodeControlService> implements WSCommand {

	public static String ID = "org.orbit.component.runtime.nodecontrol.NodeDeleteWSCommand";

	public NodeDeleteWSCommand() {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.DELETE_NODE.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
