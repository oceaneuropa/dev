...
public class NodeStopWSCommand extends AbstractOrbitCommand<NodeControlService> implements WSCommand {

	public static String ID = "org.orbit.component.runtime.nodecontrol.NodeStopWSCommand";

	public NodeStopWSCommand() {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.STOP_NODE.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
	...
	public Response execute(Request request) throws Exception {
		...
		boolean succeed = this.service.stopNode(id, accessToken, options);
