...
public class NodeAttributeAddWSCommand extends AbstractOrbitCommand<NodeControlService> implements WSCommand {

	public static String ID = "org.orbit.component.runtime.nodecontrol.NodeAttributeAddWSCommand";

	public NodeAttributeAddWSCommand() {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.ADD_NODE_ATTR.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
	...
	public Response execute(Request request) throws Exception {
		...
		boolean succeed = this.service.addAttribute(id, name, value);
