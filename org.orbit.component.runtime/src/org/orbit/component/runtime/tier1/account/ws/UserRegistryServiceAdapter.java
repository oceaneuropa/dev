...
public class UserRegistryServiceAdapter {
	...
	protected void doStart(BundleContext bundleContext, UserRegistryService service) {
		...
		IExtension extension = PlatformSDKActivator.getInstance().getExtensionRegistry().getExtension(ServiceIndexTimerFactory.EXTENSION_TYPE_ID, OrbitConstants.USER_REGISTRY_INDEXER_ID);
		if (extension != null) {
