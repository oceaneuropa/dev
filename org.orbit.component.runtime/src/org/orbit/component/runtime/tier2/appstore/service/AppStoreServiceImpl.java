...
public class AppStoreServiceImpl implements AppStoreService, LifecycleAware {
	...
	public void start(BundleContext bundleContext) {
		...
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_JDBC_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
	...
	public synchronized void updateProperties(Map<Object, Object> configProps) {
		...
		String name = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_NAME);
		String hostURL = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_HOST_URL);
		String contextRoot = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_CONTEXT_ROOT);
		String jdbcDriver = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		String jdbcURL = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_URL);
		String jdbcUsername = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		String jdbcPassword = (String) configProps.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
		...
		if (printProps) {
			...
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_NAME + " = " + name);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_HOST_URL + " = " + hostURL);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_CONTEXT_ROOT + " = " + contextRoot);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_JDBC_DRIVER + " = " + jdbcDriver);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_JDBC_URL + " = " + jdbcURL);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_JDBC_USERNAME + " = " + jdbcUsername);
			System.out.println(ComponentsConstants.COMPONENT_APP_STORE_JDBC_PASSWORD + " = " + jdbcPassword);
			System.out.println("-----------------------------------------------------");
			System.out.println();
		}
	...
	protected synchronized Properties getConnectionProperties(Map<Object, Object> props) {
		String driver = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		String url = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_URL);
		String username = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		String password = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
	...
	public String getName() {
		String name = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_NAME);
		return name;
	}

	@Override
	public String getHostURL() {
		String hostURL = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_HOST_URL);
		if (hostURL != null) {
			return hostURL;
		}
	...
	public String getContextRoot() {
		String contextRoot = (String) this.properties.get(ComponentsConstants.COMPONENT_APP_STORE_CONTEXT_ROOT);
		return contextRoot;
	}
