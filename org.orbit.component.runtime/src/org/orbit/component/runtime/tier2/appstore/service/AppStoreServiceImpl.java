...
public class AppStoreServiceImpl implements AppStoreService, LifecycleAware {
	...
	public void start(BundleContext bundleContext) {
		...
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_HOST_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_NAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_CONTEXT_ROOT);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_JDBC_URL);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		PropertyUtil.loadProperty(bundleContext, properties, ComponentConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
	...
	public synchronized void updateProperties(Map<Object, Object> configProps) {
		...
		String name = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_NAME);
		String hostURL = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_HOST_URL);
		String contextRoot = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_CONTEXT_ROOT);
		String jdbcDriver = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		String jdbcURL = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_URL);
		String jdbcUsername = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		String jdbcPassword = (String) configProps.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
		...
		if (printProps) {
			...
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_NAME + " = " + name);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_HOST_URL + " = " + hostURL);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_CONTEXT_ROOT + " = " + contextRoot);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_JDBC_DRIVER + " = " + jdbcDriver);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_JDBC_URL + " = " + jdbcURL);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_JDBC_USERNAME + " = " + jdbcUsername);
			System.out.println(ComponentConstants.COMPONENT_APP_STORE_JDBC_PASSWORD + " = " + jdbcPassword);
			System.out.println("-----------------------------------------------------");
			System.out.println();
		}
	...
	protected synchronized Properties getConnectionProperties(Map<Object, Object> props) {
		String driver = (String) this.properties.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_DRIVER);
		String url = (String) this.properties.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_URL);
		String username = (String) this.properties.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_USERNAME);
		String password = (String) this.properties.get(ComponentConstants.COMPONENT_APP_STORE_JDBC_PASSWORD);
	...
	public String getHostURL() {
		String hostURL = (String) this.properties.get(ComponentConstants.COMPONENT_APP_STORE_HOST_URL);
		if (hostURL != null) {
			return hostURL;
		}
