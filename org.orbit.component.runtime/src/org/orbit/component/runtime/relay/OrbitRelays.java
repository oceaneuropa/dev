...
import org.origin.common.rest.util.WebServiceAwareImpl;
...
public class OrbitRelays {
	 ...
	 * @return
	 */
	public WSRelayApplication createNodeManagementRelay(BundleContext bundleContext, Map<Object, Object> initProperties) {
		Map<Object, Object> properties = new Hashtable<Object, Object>();
		if (initProperties != null) {
			properties.putAll(initProperties);
		}
...
// protected WSRelayApplication nodeManagementRelay;
