...
public class ConfigRegistryServicePropertyTester implements IPropertyTester {
	...
	public boolean accept(Object context, Object source, Object target, Map<String, Object> args) {
		...
		if (bundleContext != null) {
			...
			String hostURL = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_HOST_URL);
			String name = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_NAME);
			String contextRoot = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_CONTEXT_ROOT);
			String jdbcDriver = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_JDBC_DRIVER);
			String jdbcURL = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_JDBC_URL);
			String jdbcUsername = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_JDBC_USERNAME);
			String jdbcPassword = (String) properties.get(OrbitConstants.COMPONENT_CONFIG_REGISTRY_JDBC_PASSWORD);
