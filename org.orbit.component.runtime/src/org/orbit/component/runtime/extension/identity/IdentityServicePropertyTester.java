...
public class IdentityServicePropertyTester implements IPropertyTester {
	...
	public boolean accept(Object context, Object source, Object target, Map<String, Object> args) {
		...
		if (bundleContext != null) {
			...
			PropertyUtil.loadProperty(bundleContext, properties, ComponentsConstants.COMPONENT_IDENTITY_AUTOSTART);
			String autoStart = (String) properties.get(ComponentsConstants.COMPONENT_IDENTITY_AUTOSTART);
