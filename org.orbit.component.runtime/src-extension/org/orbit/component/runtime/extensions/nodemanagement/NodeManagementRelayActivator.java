...
public class NodeManagementRelayActivator implements ServiceActivator {

	public static final String ID = "org.orbit.component.runtime.NodeManagementRelayActivator";

	public static NodeManagementRelayActivator INSTANCE = new NodeManagementRelayActivator();
	...
	public void start(IPlatformContext context, IProcess process) {
		...
		// Start relay
		WSRelayApplication relay = OrbitRelays.getInstance().createNodeManagementRelay(bundleContext, properties);
		if (relay != null) {
