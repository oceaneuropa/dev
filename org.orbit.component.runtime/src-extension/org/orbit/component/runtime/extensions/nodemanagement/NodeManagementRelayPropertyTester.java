...
public class NodeManagementRelayPropertyTester implements IPropertyTester {

	public static String ID = "org.orbit.component.runtime.NodeManagementRelayPropertyTester";

	public static NodeManagementRelayPropertyTester INSTANCE = new NodeManagementRelayPropertyTester();
	...
	public boolean accept(Object context, Object source, Object target, Map<String, Object> args) {
		...
		if (bundleContext != null) {
			...
			PropertyUtil.loadProperty(bundleContext, properties, OrbitRelayConstants.COMPONENT_NODE_MANAGEMENT_RELAY_NAME);
			PropertyUtil.loadProperty(bundleContext, properties, OrbitRelayConstants.COMPONENT_NODE_MANAGEMENT_RELAY_CONTEXT_ROOT);
			PropertyUtil.loadProperty(bundleContext, properties, OrbitRelayConstants.COMPONENT_NODE_MANAGEMENT_RELAY_HOSTS);
			PropertyUtil.loadProperty(bundleContext, properties, OrbitRelayConstants.COMPONENT_NODE_MANAGEMENT_RELAY_URLS);

			String globalHostURL = (String) properties.get(OrbitRelayConstants.ORBIT_HOST_URL);
			String name = (String) properties.get(OrbitRelayConstants.COMPONENT_NODE_MANAGEMENT_RELAY_NAME);
