...
public class DataTubeConfigImpl implements DataTubeConfig {
	 ...
	 */
	public DataTubeConfigImpl(DataCastClient dataCastClient) {
	 ...
	 * @param dateModified
	 */
	public DataTubeConfigImpl(DataCastClient dataCastClient, String id, String dataCastId, String dataTubeId, String name, boolean enabled, Map<String, Object> properties, long dateCreated, long dateModified) {
		this.dataCastClient = dataCastClient;
		this.id = id;
